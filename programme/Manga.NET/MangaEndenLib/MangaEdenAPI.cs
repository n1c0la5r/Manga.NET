...
using MangaLib;
namespace MangaEdenLib {
    public class MangaEdenAPI : MangaLoader {
        private static readonly HttpClient client = new HttpClient();
        static string MangaListURL = "https://www.mangaeden.com/api/list/0/";
        static string MangaURL = "https://www.mangaeden.com/api/manga/";
        static string ChapterURL = "https://www.mangaeden.com/api/chapter/";
        static string CoverURL = "https://cdn.mangaeden.com/mangasimg/200x/";
        static string PageURL = "https://cdn.mangaeden.com/mangasimg/";
